...
def process_server_message(response):
    ...
    if response.startswith("LOGIN"):
        ...
        if room_list_message is not None:
            sys.stdout.write(room_list_message + "\n")
        else:
            sys.stdout.write("Room list response is empty.\n")
...
def handle_forfeit(client_socket):
    try:
        ...
        sys.stderr.write("Connection closed: cannot send FORFEIT.\n")
...
def execute_place_client(client_socket):
    ...
    try:
        ...
        sys.stderr.write("Connection closed: cannot send PLACE command.\n")
...
def handle_login(client_socket):
    ...
    try:
        ...
        sys.stderr.write("Connection closed: cannot send LOGIN.\n")
...
def handle_register(client_socket):
    ...
    try:
        ...
        sys.stderr.write("Connection closed: cannot send REGISTER.\n")
...
def handle_room_list(client_socket):
    ...
    try:
        ...
        sys.stderr.write("Connection closed: cannot send ROOMLIST.\n")
...
def handle_create(client_socket):
    ...
    try:
        ...
        sys.stderr.write("Connection closed: cannot send CREATE.\n")
...
def handle_join(client_socket):
    ...
    try:
        ...
        sys.stderr.write("Connection closed: cannot send JOIN.\n")
